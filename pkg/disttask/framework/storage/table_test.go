...
func TestSubTaskTable(t *testing.T) {
	...
	subtasks, err := sm.GetSucceedSubtasksByStep(ctx, 2, proto.StepInit)
	require.NoError(t, err)
...
func TestBothGlobalAndSubTaskTable(t *testing.T) {
	...
	failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/framework/storage/MockUpdateTaskErr", "1*return(true)")
	defer func() {
...
func TestSubtaskHistoryTable(t *testing.T) {
	...
	failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/framework/storage/subtaskHistoryKeepSeconds", "return(1)")
	defer func() {
