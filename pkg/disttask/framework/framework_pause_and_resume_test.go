...
import (
	...
	"github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/framework/handle"
...
func TestFrameworkPauseAndResume(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/framework/dispatcher/pauseTaskAfterRefreshTask", "2*return(true)"))
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/framework/dispatcher/syncAfterResume", "return()"))
	DispatchTaskAndCheckState(ctx, "key1", t, &m, proto.TaskStatePaused)
	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/framework/dispatcher/pauseTaskAfterRefreshTask"))
	...
	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/framework/dispatcher/syncAfterResume"))
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/framework/dispatcher/pausePendingTask", "2*return(true)"))
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/framework/dispatcher/syncAfterResume", "1*return()"))
	DispatchTaskAndCheckState(ctx, "key2", t, &m, proto.TaskStatePaused)

	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/framework/dispatcher/pausePendingTask"))
	// 4 subtask dispatched.
