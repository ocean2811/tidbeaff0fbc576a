...
- Highly compatible with MySQL: it supports almost all features of MySQL. For the complete details, see [parser.y](https://github.com/ocean2811/tidbeaff0fbc576a/blob/master/parser/parser.y) and [hintparser.y](https://github.com/ocean2811/tidbeaff0fbc576a/blob/master/parser/hintparser.y).
...
Please read the [quickstart](https://github.com/ocean2811/tidbeaff0fbc576a/blob/master/parser/docs/quickstart.md).
...
- [GitHub Issue](https://github.com/ocean2811/tidbeaff0fbc576a/issues)
...
- [pingcap/tidb](https://github.com/ocean2811/tidbeaff0fbc576a)
