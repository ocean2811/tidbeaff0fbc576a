...
func (b *Builder) applyExchangeTablePartition(m *meta.Meta, diff *model.SchemaDiff) ([]int64, error) {
	...
	currDiff := &model.SchemaDiff{
		// This is only for the case since https://github.com/ocean2811/tidbeaff0fbc576a/pull/45877
...
func (b *Builder) applyTableUpdate(m *meta.Meta, diff *model.SchemaDiff) ([]int64, error) {
	...
	case model.ActionCreateTable:
		// WARN: when support create table with foreign key in https://github.com/ocean2811/tidbeaff0fbc576a/pull/37148,
