...
import (
	...
	dbsession "github.com/ocean2811/tidbeaff0fbc576a/pkg/session"
	...
	timertable "github.com/ocean2811/tidbeaff0fbc576a/pkg/timer/tablestore"
	"github.com/ocean2811/tidbeaff0fbc576a/pkg/ttl/cache"
	"github.com/ocean2811/tidbeaff0fbc576a/pkg/ttl/client"
	"github.com/ocean2811/tidbeaff0fbc576a/pkg/ttl/metrics"
	"github.com/ocean2811/tidbeaff0fbc576a/pkg/ttl/session"
	"github.com/ocean2811/tidbeaff0fbc576a/pkg/ttl/ttlworker"
...
func TestTTLAutoAnalyze(t *testing.T) {
	failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ttl/ttlworker/update-info-schema-cache-interval", fmt.Sprintf("return(%d)", time.Second))
	defer failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ttl/ttlworker/update-info-schema-cache-interval")
	failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ttl/ttlworker/update-status-table-cache-interval", fmt.Sprintf("return(%d)", time.Second))
	defer failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ttl/ttlworker/update-status-table-cache-interval")
	failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ttl/ttlworker/resize-workers-interval", fmt.Sprintf("return(%d)", time.Second))
	defer failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ttl/ttlworker/resize-workers-interval")
	failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ttl/ttlworker/task-manager-loop-interval", fmt.Sprintf("return(%d)", time.Second))
	defer failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ttl/ttlworker/task-manager-loop-interval")
