...
func TestTimeZone(t *testing.T) {
	...
	// See: https://github.com/ocean2811/tidbeaff0fbc576a/issues/8087
...
func TestTiDBServerMemoryLimit2(t *testing.T) {
	...
	require.Nil(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/util/memory/GetMemTotalError", `return(true)`))
	require.Error(t, mock.SetGlobalSysVar(context.Background(), TiDBServerMemoryLimit, "75%"))
	require.Nil(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/util/memory/GetMemTotalError"))
