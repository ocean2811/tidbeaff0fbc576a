...
var noopSysVars = []*SysVar{
	...
	{Scope: ScopeGlobal | ScopeSession, Name: SQLAutoIsNull, Value: Off, Type: TypeBool, IsHintUpdatableVerfied: true, Validation: func(vars *SessionVars, normalizedValue string, originalValue string, scope ScopeFlag) (string, error) {
		...
		// See also https://github.com/ocean2811/tidbeaff0fbc576a/issues/28230
	...
	// lc_messages cannot be read_only, see https://github.com/ocean2811/tidbeaff0fbc576a/issues/38231.
	...
	// See: https://github.com/ocean2811/tidbeaff0fbc576a/pull/6068 for details
