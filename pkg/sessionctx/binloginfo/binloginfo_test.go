...
func createBinlogSuite(t *testing.T) (s *binlogSuite) {
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/store/driver/txn/mockSyncBinlogCommit", `return(true)`))
	...
	t.Cleanup(func() {
		...
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/store/driver/txn/mockSyncBinlogCommit"))
	})
