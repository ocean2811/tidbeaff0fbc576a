...
func TestGlobalStatsPanicInIOWorker(t *testing.T) {
	fpName := "github.com/ocean2811/tidbeaff0fbc576a/pkg/statistics/handle/globalstats/PanicInIOWorker"
...
func TestGlobalStatsWithCMSketchErr(t *testing.T) {
	fpName := "github.com/ocean2811/tidbeaff0fbc576a/pkg/statistics/handle/globalstats/dealCMSketchErr"
...
func TestGlobalStatsWithHistogramAndTopNErr(t *testing.T) {
	fpName := "github.com/ocean2811/tidbeaff0fbc576a/pkg/statistics/handle/globalstats/dealHistogramAndTopNErr"
	require.NoError(t, failpoint.Enable(fpName, `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable(fpName))
	}()
...
func TestGlobalStatsPanicInCPUWorker(t *testing.T) {
	fpName := "github.com/ocean2811/tidbeaff0fbc576a/pkg/statistics/handle/globalstats/PanicInCPUWorker"
	require.NoError(t, failpoint.Enable(fpName, "panic(\"inject panic\")"))
	defer func() {
		require.NoError(t, failpoint.Disable(fpName))
	}()
...
func TestGlobalStatsPanicSametime(t *testing.T) {
	fpName := "github.com/ocean2811/tidbeaff0fbc576a/pkg/statistics/handle/globalstats/PanicSameTime"
	require.NoError(t, failpoint.Enable(fpName, `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable(fpName))
	}()
...
func TestGlobalStatsErrorSametime(t *testing.T) {
	fpName := "github.com/ocean2811/tidbeaff0fbc576a/pkg/statistics/handle/globalstats/ErrorSameTime"
	require.NoError(t, failpoint.Enable(fpName, `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable(fpName))
	}()
