...
func TestExpBackoffEstimation(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/planner/cardinality/cleanEstResults", `return(true)`))
	testdata.OnRecord(func() {
	...
	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/planner/cardinality/cleanEstResults"))
}
