...
import (
	...
	tablefilter "github.com/ocean2811/tidbeaff0fbc576a/pkg/util/table-filter"
...
func ParseCaptureTableFilter(tableFilter string) (f tablefilter.Filter, valid bool) {
	...
	// please see https://github.com/ocean2811/tidbeaff0fbc576a-tools/tree/master/pkg/table-filter for more details.
