...
func TestCTEIssue49096(t *testing.T) {
	...
	tk.MustExec("use test;")
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/mock_cte_exec_panic_avoid_deadlock", "return(true)"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/mock_cte_exec_panic_avoid_deadlock"))
	}()
	insertStr := "insert into t1 values(0)"
	rowNum := 10
...
func TestSpillToDisk(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/testCTEStorageSpill", "return(true)"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/testCTEStorageSpill"))
...
// https://github.com/ocean2811/tidbeaff0fbc576a/issues/33965.
...
func TestCTEPanic(t *testing.T) {
	...
	fpPathPrefix := "github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/"
	fp := "testCTESeedPanic"
