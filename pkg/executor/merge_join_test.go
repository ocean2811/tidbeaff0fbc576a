...
func TestShuffleMergeJoinInDisk(t *testing.T) {
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/testMergeJoinRowContainerSpill", "return(true)"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/testMergeJoinRowContainerSpill"))
	}()
...
func TestMergeJoin(t *testing.T) {
	...
	// Test TIDB_SMJ for join with order by desc, see https://github.com/ocean2811/tidbeaff0fbc576a/issues/14483
	tk.MustExec("drop table if exists t")
	tk.MustExec("drop table if exists t1")
