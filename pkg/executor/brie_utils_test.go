...
func TestSplitBatchCreateTable(t *testing.T) {
	...
	// keep/reused table id verification
	tk.Session().SetValue(sessionctx.QueryString, "skip")
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/RestoreBatchCreateTableEntryTooLarge", "return(1)"))
	...
	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/RestoreBatchCreateTableEntryTooLarge"))
}
...
func TestSplitBatchCreateTableFailWithEntryTooLarge(t *testing.T) {
	...
	tk.Session().SetValue(sessionctx.QueryString, "skip")
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/RestoreBatchCreateTableEntryTooLarge", "return(0)"))
	err := executor.SplitBatchCreateTableForTest(sctx, model.NewCIStr("test"), infos, ddl.AllocTableIDIf(func(ti *model.TableInfo) bool {
		return true
	}))
	require.Equal(t, "skip", sctx.Value(sessionctx.QueryString))
