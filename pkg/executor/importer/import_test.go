...
func TestInitDefaultOptions(t *testing.T) {
	plan := &Plan{}
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/importer/mockNumCpu", "return(1)"))
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/importer/mockNumCpu", "return(10)"))
	plan.initDefaultOptions()
...
func TestAdjustDiskQuota(t *testing.T) {
	err := failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/common/GetStorageSize", "return(2048)")
	require.NoError(t, err)
	defer func() {
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/common/GetStorageSize")
	}()
	d := t.TempDir()
...
func TestGetFileRealSize(t *testing.T) {
	err := failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/mydump/SampleFileCompressPercentage", "return(250)")
	require.NoError(t, err)
	defer func() {
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/mydump/SampleFileCompressPercentage")
	}()
	...
	err = failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/mydump/SampleFileCompressPercentage", `return("test err")`)
	require.NoError(t, err)
	require.Equal(t, int64(100), c.getFileRealSize(context.Background(), fileMeta, nil))
}
