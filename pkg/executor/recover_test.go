...
func TestRecoverTable(t *testing.T) {
	...
	// related issue: https://github.com/ocean2811/tidbeaff0fbc576a/issues/46296
...
func TestRecoverTableMeetError(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/mockUpdateVersionAndTableInfoErr", `return(1)`))
...
func TestFlashbackWithSafeTs(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/mockFlashbackTest", `return(true)`))
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/changeFlashbackGetMinSafeTimeTimeout", `return(0)`))
	...
	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/injectSafeTS"))
	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/mockFlashbackTest"))
	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/changeFlashbackGetMinSafeTimeTimeout"))
}
