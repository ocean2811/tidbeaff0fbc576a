...
func TestInsertOnDuplicateKeyWithBinlog(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/table/tables/forceWriteBinlog", "return")
	defer failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/table/tables/forceWriteBinlog")
	testInsertOnDuplicateKey(t, tk)
}
...
// Fix https://github.com/ocean2811/tidbeaff0fbc576a/issues/32601.
...
func TestDuplicateEntryMessage(t *testing.T) {
	...
	for _, enable := range []variable.ClusteredIndexDefMode{variable.ClusteredIndexDefModeOn, variable.ClusteredIndexDefModeOff, variable.ClusteredIndexDefModeIntOnly} {
		...
		// See https://github.com/ocean2811/tidbeaff0fbc576a/issues/12420.
		tk.MustExec("drop table if exists t;")
...
// TestDuplicatedEntryErr See https://github.com/ocean2811/tidbeaff0fbc576a/issues/24582
...
// https://github.com/ocean2811/tidbeaff0fbc576a/issues/29483.
...
// https://github.com/ocean2811/tidbeaff0fbc576a/issues/32213.
...
// see issue: https://github.com/ocean2811/tidbeaff0fbc576a/issues/47945
