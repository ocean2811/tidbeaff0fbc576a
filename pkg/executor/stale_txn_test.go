...
func TestSelectAsOf(t *testing.T) {
	...
	for _, testcase := range testcases1 {
		...
		require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/assertStaleTSO", fmt.Sprintf(`return(%d)`, testcase.expectPhysicalTS)))
		...
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/assertStaleTSO"))
		if len(testcase.setTxnSQL) > 0 {
	...
	for _, testcase := range testcases2 {
		...
		if testcase.preSec > 0 {
			require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/expression/injectNow", fmt.Sprintf(`return(%d)`, now.Unix())))
			require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/assertStaleTSO", fmt.Sprintf(`return(%d)`, now.Unix()-testcase.preSec)))
		}
		rs, err := tk.Exec(testcase.sql)
		if len(testcase.errorStr) != 0 {
			require.Regexp(t, testcase.errorStr, err.Error())
		...
		if testcase.preSec > 0 {
			require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/expression/injectNow"))
			require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/assertStaleTSO"))
		}
	}
}
...
func TestStaleReadKVRequest(t *testing.T) {
	...
	testcases := []struct {
	...
	}{
		{
			...
			sql:    "select * from t",
			assert: "github.com/ocean2811/tidbeaff0fbc576a/pkg/distsql/assertRequestBuilderReplicaOption",
		},
		{
			name:   "point get read",
			sql:    "select * from t where id = 1",
			assert: "github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/assertPointReplicaOption",
		},
		{
			name:   "batch point get read",
			sql:    "select * from t where id in (1,2,3)",
			assert: "github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/assertBatchPointReplicaOption",
		},
	}
...
func TestTimeBoundedStalenessTxn(t *testing.T) {
	...
	for _, testcase := range testcases {
		...
		require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/expression/injectSafeTS",
			fmt.Sprintf("return(%v)", testcase.injectSafeTS)))
		tk.MustExec(testcase.sql)
	...
	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/expression/injectSafeTS"))
...
func TestSetTransactionReadOnlyAsOf(t *testing.T) {
	...
	for _, testcase := range testcases {
		...
		failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/expression/injectSafeTS")
	}
...
func TestStaleReadPrepare(t *testing.T) {
	...
	failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/assertExecutePrepareStatementStalenessOption",
	...
	tk.MustExec("execute p2")
	failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/assertExecutePrepareStatementStalenessOption")
...
func TestStmtCtxStaleFlag(t *testing.T) {
	...
	for _, testcase := range testcases {
		failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/exector/assertStmtCtxIsStaleness",
			fmt.Sprintf("return(%v)", testcase.hasStaleFlag))
		tk.MustExec(testcase.sql)
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/exector/assertStmtCtxIsStaleness"))
...
func TestStaleSessionQuery(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/expression/injectNow", fmt.Sprintf(`return(%d)`, now.Unix())))
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/assertStaleTSO", fmt.Sprintf(`return(%d)`, now.Unix()-1)))
...
func TestStaleReadCompatibility(t *testing.T) {
	...
	tk.MustExec("set @@tidb_read_staleness='-1'")
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/expression/injectNow", fmt.Sprintf(`return(%d)`, t1.Unix())))
...
func TestStaleReadNoExtraTSORequest(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/session/assertTSONotRequest", `return(true)`))
	tk.MustQuery("select * from t as of timestamp NOW() - INTERVAL 2 SECOND")
	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/session/assertTSONotRequest"))
...
func TestStaleTSO(t *testing.T) {
	...
	require.Nil(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/sessiontxn/staleread/mockStaleReadTSO", fmt.Sprintf("return(%d)", nextTSO)))
	defer failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/sessiontxn/staleread/mockStaleReadTSO")
