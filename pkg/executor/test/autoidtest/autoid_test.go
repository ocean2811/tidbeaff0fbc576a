...
func TestMockAutoIDServiceError(t *testing.T) {
	...
	failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/autoid_service/mockErr", `return(true)`)
	defer failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/autoid_service/mockErr")
...
func TestAutoIDConstraint(t *testing.T) {
	...
	// See https://github.com/ocean2811/tidbeaff0fbc576a/issues/40580
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test;")
