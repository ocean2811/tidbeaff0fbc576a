...
func TestIndexNestedLoopHashJoin(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/planner/core/MockOnlyEnableIndexHashJoin", "return(true)"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/planner/core/MockOnlyEnableIndexHashJoin"))
	}()
...
func TestIssue18572_1(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/testIndexHashJoinInnerWorkerErr", "return"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/testIndexHashJoinInnerWorkerErr"))
	}()
...
func TestIssue18572_3(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/testIndexHashJoinBuildErr", "return"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/testIndexHashJoinBuildErr"))
	}()
...
func TestIssue20270(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/killedInJoin2Chunk", "return(true)"))
	...
	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/killedInJoin2Chunk"))
	plannercore.ForceUseOuterBuild4Test.Store(true)
	defer func() {
		plannercore.ForceUseOuterBuild4Test.Store(false)
	}()
	err = failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/killedInJoin2ChunkForOuterHashJoin", "return(true)")
	require.NoError(t, err)
	...
	require.Equal(t, exeerrors.ErrQueryInterrupted, err)
	err = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/killedInJoin2ChunkForOuterHashJoin")
	require.NoError(t, err)
}
...
func TestIssue31129(t *testing.T) {
	...
	// Test IndexNestedLoopHashJoin keepOrder.
	fpName := "github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/TestIssue31129"
	...
	fpName = "github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/IndexHashJoinBuildHashTablePanic"
	...
	fpName = "github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/IndexHashJoinFetchInnerResultsErr"
	require.NoError(t, failpoint.Enable(fpName, "return"))
	err = tk.QueryToErr("select /*+ INL_HASH_JOIN(s) */ * from t left join s on t.a=s.a order by t.pk")
	...
	fpName1, fpName2 := "github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/IndexHashJoinBuildHashTablePanic", "github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/IndexHashJoinFetchInnerResultsErr"
