...
func TestIssue18070(t *testing.T) {
	...
	fpName := "github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/mockIndexMergeJoinOOMPanic"
...
func TestIssue20779(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/testIssue20779", "return"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/testIssue20779"))
	}()
...
func TestIssue30211(t *testing.T) {
	...
	tk.MustExec("create table t2(a int, index(a));")
	func() {
		fpName := "github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/TestIssue30211"
...
func TestIssue49033(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/testIssue49033", "return"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/testIssue49033"))
	}()
