...
func TestRandomPanicConsume(t *testing.T) {
	...
	fpName := "github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/aggregate/ConsumeRandomPanic"
	require.NoError(t, failpoint.Enable(fpName, "5%panic(\"ERROR 1105 (HY000): Out Of Memory Quota![conn=1]\")"))
	defer func() {
		require.NoError(t, failpoint.Disable(fpName))
	}()
	fpName2 := "github.com/ocean2811/tidbeaff0fbc576a/pkg/store/copr/ConsumeRandomPanic"
