...
// to fix https://github.com/ocean2811/tidbeaff0fbc576a/issues/27952
...
func TestPartitionTable(t *testing.T) {
	...
	tk.MustExec("insert into t values(3,0)")
	tk.MustExec("insert into t values(4,0)")
	failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/checkUseMPP", `return(true)`)
	tk.MustExec("set @@session.tidb_isolation_read_engines=\"tiflash\"")
	tk.MustExec("set @@session.tidb_allow_mpp=ON")
	tk.MustExec("set @@session.tidb_opt_enable_late_materialization=OFF")
	// mock executor does not support use outer table as build side for outer join, so need to
	// force the inner table as build side
	tk.MustExec("set tidb_opt_mpp_outer_join_fixed_build_side=1")
	failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/internal/mpp/checkTotalMPPTasks", `return(2)`)
	tk.MustQuery("select count(*) from t").Check(testkit.Rows("4"))
	failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/internal/mpp/checkTotalMPPTasks")
	...
	failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/internal/mpp/checkTotalMPPTasks", `return(4)`)
	...
	failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/internal/mpp/checkTotalMPPTasks", `return(5)`)
	...
	failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/internal/mpp/checkTotalMPPTasks")
	failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/internal/mpp/checkTotalMPPTasks", `return(3)`)
	tk.MustQuery("select count(*) from t, t3 where t3.a = t.a and t3.b > 10").Check(testkit.Rows("0"))
	failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/internal/mpp/checkTotalMPPTasks")
	failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/checkUseMPP")
}
...
func TestDispatchTaskRetry(t *testing.T) {
	...
	require.NoError(t, err)
	tk.MustExec("set @@session.tidb_enforce_mpp=ON")
	require.Nil(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/store/mockstore/unistore/mppDispatchTimeout", "3*return(true)"))
	tk.MustQuery("select count(*) from t group by b").Check(testkit.Rows("4"))
	require.Nil(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/store/mockstore/unistore/mppDispatchTimeout"))
}
...
func TestMppVersionError(t *testing.T) {
	...
	tk.MustExec("set @@session.tidb_enforce_mpp=ON")
	{
		...
		require.Nil(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/store/mockstore/unistore/MppVersionError", item))
	}
	{
		err := tk.QueryToErr("select count(*) from t group by b")
		require.Error(t, err)
	}
	require.Nil(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/store/mockstore/unistore/MppVersionError"))
	{
...
func TestCancelMppTasks(t *testing.T) {
	var hang = "github.com/ocean2811/tidbeaff0fbc576a/pkg/store/mockstore/unistore/mppRecvHang"
	store := testkit.CreateMockStore(t, withMockTiFlash(2))
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
...
func TestMppGoroutinesExitFromErrors(t *testing.T) {
	...
	var mppNonRootTaskError = "github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/internal/mpp/mppNonRootTaskError"
...
func TestMppUnionAll(t *testing.T) {
	...
	failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/internal/mpp/checkTotalMPPTasks", `return(6)`)
	tk.MustQuery("select count(*) from (select * from x1 union all select * from x2 union all select * from x3) x join (select * from x1 union all select * from x2 union all select * from x3) y on x.a = y.b").Check(testkit.Rows("29"))
	failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/internal/mpp/checkTotalMPPTasks")
...
func TestTiflashPartitionTableScan(t *testing.T) {
	...
	wg := sync.WaitGroup{}
	wg.Add(1)
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/store/mockstore/unistore/rpcServerBusy", `return(true)`))
	go func() {
		time.Sleep(100 * time.Millisecond)
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/store/mockstore/unistore/rpcServerBusy"))
		wg.Done()
	}()
	tk.MustExec("set @@session.tidb_allow_mpp=ON;")
	tk.MustQuery("select count(*) from t where a < 12;").Check(testkit.Rows("2"))
...
func TestMPPMemoryTracker(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/internal/mpp/testMPPOOMPanic", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/internal/mpp/testMPPOOMPanic"))
	}()
...
func TestTiFlashComputeDispatchPolicy(t *testing.T) {
	...
	// Valid values.
	defer failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/store/copr/testWhichDispatchPolicy")
	for _, useAS := range useASs {
		...
		for _, p := range validPolicies {
			...
			require.Nil(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/store/copr/testWhichDispatchPolicy", fmt.Sprintf(`return("%s")`, p)))
			...
			require.Nil(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/store/copr/testWhichDispatchPolicy"))
		}
	}
}
...
func TestMppStoreCntWithErrors(t *testing.T) {
	// mock non-root tasks return error
	var mppStoreCountPDError = "github.com/ocean2811/tidbeaff0fbc576a/pkg/store/copr/mppStoreCountPDError"
	var mppStoreCountSetMPPCnt = "github.com/ocean2811/tidbeaff0fbc576a/pkg/store/copr/mppStoreCountSetMPPCnt"
	var mppStoreCountSetLastUpdateTime = "github.com/ocean2811/tidbeaff0fbc576a/pkg/store/copr/mppStoreCountSetLastUpdateTime"
	var mppStoreCountSetLastUpdateTimeP2 = "github.com/ocean2811/tidbeaff0fbc576a/pkg/store/copr/mppStoreCountSetLastUpdateTimeP2"
