...
func TestInspectionTables(t *testing.T) {
	...
	fpName := "github.com/ocean2811/tidbeaff0fbc576a/pkg/infoschema/mockClusterInfo"
...
func TestColumnsTables(t *testing.T) {
	...
	// For issue: https://github.com/ocean2811/tidbeaff0fbc576a/issues/43379
...
// https://github.com/ocean2811/tidbeaff0fbc576a/issues/25467.
...
// https://github.com/ocean2811/tidbeaff0fbc576a/issues/32693.
...
func TestTiFlashSystemTableWithTiFlashV620(t *testing.T) {
	...
	fpName := "github.com/ocean2811/tidbeaff0fbc576a/pkg/infoschema/mockStoreServerInfo"
	fpExpr := `return("` + strings.Join(instances, ";") + `")`
	require.NoError(t, failpoint.Enable(fpName, fpExpr))
	defer func() { require.NoError(t, failpoint.Disable(fpName)) }()
...
// https://github.com/ocean2811/tidbeaff0fbc576a/issues/32459.
...
// https://github.com/ocean2811/tidbeaff0fbc576a/issues/36426.
