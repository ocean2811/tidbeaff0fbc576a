...
func TestDateFormat(t *testing.T) {
	ctx := createContext(t)
	// Test case for https://github.com/ocean2811/tidbeaff0fbc576a/issues/2908
...
func TestUnixTimestamp(t *testing.T) {
	...
	// https://github.com/ocean2811/tidbeaff0fbc576a/issues/2496
	...
	// https://github.com/ocean2811/tidbeaff0fbc576a/issues/2852
...
func TestTiDBBoundedStaleness(t *testing.T) {
	...
	for _, test := range tests {
		require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/expression/injectSafeTS", fmt.Sprintf("return(%v)", test.injectSafeTS)))
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/expression/injectSafeTS", fmt.Sprintf("return(%v)", safeTS1)))
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/expression/injectSafeTS", fmt.Sprintf("return(%v)", safeTS2)))
	f, err = fc.getFunction(ctx, datumsToConstants([]types.Datum{types.NewDatum(t1Str), types.NewDatum(t2Str)}))
	require.NoError(t, err)
	d, err = evalBuiltinFunc(f, chunk.Row{})
	require.NoError(t, err)
