...
import (
	...
	"github.com/ocean2811/tidbeaff0fbc576a/pkg/util/generatedexpr"
...
func scalarExprSupportedByFlash(function *ScalarFunction) bool {
	...
	case ast.Cast:
		...
		case tipb.ScalarFuncSig_CastDecimalAsTime, tipb.ScalarFuncSig_CastIntAsTime, tipb.ScalarFuncSig_CastRealAsTime, tipb.ScalarFuncSig_CastTimeAsTime,
			...
			// ban the function of casting year type as time type pushing down to tiflash because of https://github.com/ocean2811/tidbeaff0fbc576a/issues/26215
