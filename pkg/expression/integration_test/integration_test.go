...
func TestTiDBDecodeKeyFunc(t *testing.T) {
	...
	// https://github.com/ocean2811/tidbeaff0fbc576a/issues/27434.
	hexKey = "7480000000000100375F69800000000000000103800000000001D4C1023B6458"
	sql = fmt.Sprintf("select tidb_decode_key('%s')", hexKey)
	tk.MustQuery(sql).Check(testkit.Rows(hexKey))

	// https://github.com/ocean2811/tidbeaff0fbc576a/issues/33015.
...
// issue https://github.com/ocean2811/tidbeaff0fbc576a/issues/28544
...
func TestTimeBuiltin(t *testing.T) {
	...
	// Issue https://github.com/ocean2811/tidbeaff0fbc576a/issues/20003
...
func TestSetVariables(t *testing.T) {
	...
	// See: https://github.com/ocean2811/tidbeaff0fbc576a/issues/24368
...
PARTITION BY RANGE (c) (
	...
	testcases := []struct {
		...
		// FIXME: block by https://github.com/ocean2811/tidbeaff0fbc576a/issues/21872
		//{
		...
		//},
		// FIXME: block by https://github.com/ocean2811/tidbeaff0fbc576a/issues/21847
		//{
...
func TestIssue43527(t *testing.T) {
	...
	tk.MustExec("insert into test values('2010-10-10 10:10:10', 100, 100.01, 100)")
	// Vectorized.
	// NOTE: Because https://github.com/ocean2811/tidbeaff0fbc576a/pull/8412 disabled the vectorized execution of get or set variable,
