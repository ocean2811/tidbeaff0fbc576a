...
import (
	...
	tidb_util "github.com/ocean2811/tidbeaff0fbc576a/pkg/util"
...
func TestUpgradeVersionForResumeJob(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/session/mockResumeAllJobsFailed", `return(true)`))
	defer failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/session/mockResumeAllJobsFailed")
