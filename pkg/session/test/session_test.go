...
func TestDoDDLJobQuit(t *testing.T) {
	...
	// test https://github.com/ocean2811/tidbeaff0fbc576a/issues/18714, imitate DM's use environment
	...
	require.Nil(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/storeCloseInLoop", `return`))
	defer func() { require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/storeCloseInLoop")) }()
...
// Testcase for https://github.com/ocean2811/tidbeaff0fbc576a/issues/325
...
func TestHandleAssertionFailureForPartitionedTable(t *testing.T) {
	...
	failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/table/tables/addRecordForceAssertExist", "return")
	defer failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/table/tables/addRecordForceAssertExist")
