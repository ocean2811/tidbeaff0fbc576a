...
func TestNonTransactionalDMLErrorMessage(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/session/batchDMLError", `return(true)`))
	defer failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/session/batchDMLError")
	...
	require.NoError(
		t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/session/batchDMLError", `1*return(false)->return(true)`),
	)
	err = tk.ExecToErr("batch on a limit 3 insert into t1 select * from t")
