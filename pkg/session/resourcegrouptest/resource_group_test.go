...
func TestResourceGroupHintInTxn(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/kv/TxnResouceGroupChecker", `return("default")`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/kv/TxnResouceGroupChecker"))
	}()
	tk.MustExec("insert into t values (1, 1);")
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/kv/TxnResouceGroupChecker", `return("rg1")`))
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/kv/TxnResouceGroupChecker", `return("rg2")`))
