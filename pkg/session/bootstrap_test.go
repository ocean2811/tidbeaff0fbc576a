...
func TestBootstrap(t *testing.T) {
	...
	// For https://github.com/ocean2811/tidbeaff0fbc576a/issues/1096
	se, err = CreateSession4Test(store)
	require.NoError(t, err)
	doDMLWorks(se)
...
func TestForIssue23387(t *testing.T) {
	// For issue https://github.com/ocean2811/tidbeaff0fbc576a/issues/23387
...
func TestTiDBUpgradeToVer136(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/reorgMetaRecordFastReorgDisabled", `return`))
	t.Cleanup(func() {
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/reorgMetaRecordFastReorgDisabled"))
	})
