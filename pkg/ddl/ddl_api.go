...
import (
	...
	rg "github.com/ocean2811/tidbeaff0fbc576a/pkg/domain/resourcegroup"
	...
	field_types "github.com/ocean2811/tidbeaff0fbc576a/pkg/parser/types"
...
func (d *ddl) createTableWithInfoPost(
	...
	// For issue https://github.com/ocean2811/tidbeaff0fbc576a/issues/46093
...
func (d *ddl) AlterTable(ctx context.Context, sctx sessionctx.Context, stmt *ast.AlterTableStmt) (err error) {
	...
	for _, spec := range validSpecs {
		...
		case ast.AlterTableDisableKeys, ast.AlterTableEnableKeys:
			// Nothing to do now, see https://github.com/ocean2811/tidbeaff0fbc576a/issues/1051
			// MyISAM specific
...
func GetModifiableColumnJob(
	...
	newCol := table.ToColumn(&model.ColumnInfo{
		ID: col.ID,
		// We use this PR(https://github.com/ocean2811/tidbeaff0fbc576a/pull/6274) as the dividing line to define whether it is a new version or an old version TiDB.
	...
	if errG != nil {
		// According to issue https://github.com/ocean2811/tidbeaff0fbc576a/issues/24321,
