...
func TestRowLevelChecksumWithMultiSchemaChange(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/forceRowLevelChecksumOnUpdateColumnBackfill", "return"))
	defer failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/forceRowLevelChecksumOnUpdateColumnBackfill")
...
func TestCancelCTCInReorgStateWillCauseGoroutineLeak(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/mockInfiniteReorgLogic", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/mockInfiniteReorgLogic"))
	}()
...
// Fix issue: https://github.com/ocean2811/tidbeaff0fbc576a/issues/26292
