...
func putTheSameDDLJobTwice(t *testing.T, fn func()) {
	err := failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/mockParallelSameDDLJobTwice", `return(true)`)
	require.NoError(t, err)
	fn()
	err = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/mockParallelSameDDLJobTwice")
	require.NoError(t, err)
}
