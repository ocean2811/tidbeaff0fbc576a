...
func TestAddBatchJobError(t *testing.T) {
	...
	require.Nil(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/mockAddBatchDDLJobsErr", `return(true)`))
	...
	require.Nil(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/mockAddBatchDDLJobsErr"))
}
