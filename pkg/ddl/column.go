...
func doReorgWorkForModifyColumn(w *worker, d *ddlCtx, t *meta.Meta, job *model.Job, tbl table.Table,
	...
	// enable: curl -X PUT -d "pause" "http://127.0.0.1:10080/fail/github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/mockDelayInModifyColumnTypeWithData".
	// disable: curl -X DELETE "http://127.0.0.1:10080/fail/github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/mockDelayInModifyColumnTypeWithData"
	...
	if tbl, ok := t.(table.PartitionedTable); ok {
		...
		for !done {
			...
			default:
				...
				// https://github.com/ocean2811/tidbeaff0fbc576a/issues/38297
