...
import (
	...
	"github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/syncer"
...
func TestDDLScheduling(t *testing.T) {
	...
	err := failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/mockRunJobTime", `return(true)`)
	require.NoError(t, err)
	defer func() {
		err := failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/mockRunJobTime")
		require.NoError(t, err)
	}()
...
func TestUpgradingRelatedJobState(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/mockUpgradingState", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/mockUpgradingState"))
	}()
