...
import (
	...
	"github.com/ocean2811/tidbeaff0fbc576a/pkg/util/parser"
	"go.uber.org/zap"
)
...
func isValidSeparator(c byte, prevParts int) bool {
	...
	// for https://github.com/ocean2811/tidbeaff0fbc576a/issues/32232
...
// explicitTz is used to handle a data race of timeZone, refer to https://github.com/ocean2811/tidbeaff0fbc576a/issues/40710. It only works for timestamp now, be careful to use it!
