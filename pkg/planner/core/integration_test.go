...
func TestSysdatePushDown(t *testing.T) {
	...
	tk.MustQuery("explain analyze select /*+read_from_storage(tikv[t])*/ * from t where d > sysdate()").
		CheckAt([]int{0, 3, 6}, rows)
	failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/expression/injectNow")
...
// Test for issue https://github.com/ocean2811/tidbeaff0fbc576a/issues/21607.
...
func TestIssue30804(t *testing.T) {
	...
	tk.MustExec("create table t1(a int, b int)")
	tk.MustExec("create table t2(a int, b int)")
	// minimal reproduction of https://github.com/ocean2811/tidbeaff0fbc576a/issues/30804
...
func TestExplainAnalyzeDMLCommit(t *testing.T) {
	...
	err := failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/session/mockSleepBeforeTxnCommit", "return(500)")
	require.NoError(t, err)
	defer func() {
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/session/mockSleepBeforeTxnCommit")
	}()
...
// https://github.com/ocean2811/tidbeaff0fbc576a/issues/38295.
// WARN: this test cannot be migrated to tests/integrationtest, because the error message of
// `SELECT t0.c1, t0.c2 FROM t0 GROUP BY MOD(t0.c0, DEFAULT(t0.c2));` is unstable.
...
// https://github.com/ocean2811/tidbeaff0fbc576a/issues/41273
...
// https://github.com/ocean2811/tidbeaff0fbc576a/issues/41355
...
// https://github.com/ocean2811/tidbeaff0fbc576a/issues/41458
