...
func TestPlanStatsLoadTimeout(t *testing.T) {
	...
	// Test Issue #50872.
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/planner/core/assertSyncWaitFailed", `return(true)`))
	tk.MustExec(sql)
	failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/planner/core/assertSyncWaitFailed")
