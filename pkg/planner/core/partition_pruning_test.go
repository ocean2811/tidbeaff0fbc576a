...
import (
	...
	"github.com/ocean2811/tidbeaff0fbc576a/pkg/testkit/ddlhelper"
...
func TestCanBePrune(t *testing.T) {
	...
	// TODO: Uncomment the check after fixing issue https://github.com/ocean2811/tidbeaff0fbc576a/issues/12028
	// require.True(t, equalPartitionRangeOR(result, partitionRangeOR{{2, 4}}))
