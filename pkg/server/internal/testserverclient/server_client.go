...
func (cli *TestServerClient) RunTestLoadData(t *testing.T, server *server.Server) {
	...
	cli.RunTestsOnNewDB(t, func(config *mysql.Config) {
		...
		require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/commitOneTaskErr", "return"))
		...
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/commitOneTaskErr"))
