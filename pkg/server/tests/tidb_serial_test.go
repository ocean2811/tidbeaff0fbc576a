...
func TestLoadDataAutoRandom(t *testing.T) {
	err := failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/BeforeCommitWork", "sleep(1000)")
	require.NoError(t, err)
	defer func() {
		//nolint:errcheck
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/BeforeCommitWork")
	}()
	ts := createTidbTestSuite(t)
