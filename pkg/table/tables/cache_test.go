...
func TestBeginSleepABA(t *testing.T) {
	...
	if !lastReadFromCache(tk1) {
		...
		// It is a bug, ref https://github.com/ocean2811/tidbeaff0fbc576a/issues/36838
...
func TestRenewLeaseABAFailPoint(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/table/tables/mockRenewLeaseABA1", `return`))
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/table/tables/mockRenewLeaseABA2", `return`))
	tk.MustQuery("select * from t_lease").Check(testkit.Rows("1 1"))
	...
	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/table/tables/mockRenewLeaseABA1"))
	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/table/tables/mockRenewLeaseABA2"))
