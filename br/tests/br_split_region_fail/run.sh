...
GO_FAILPOINTS="github.com/ocean2811/tidbeaff0fbc576a/br/pkg/restore/split/not-leader-error=1*return(true)->1*return(false);\
github.com/ocean2811/tidbeaff0fbc576a/br/pkg/restore/split/somewhat-retryable-error=3*return(true)" \
