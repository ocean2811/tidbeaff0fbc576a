...
SLOWDOWN_FAILPOINTS='github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/SlowDownImport=sleep(250)'
export GO_FAILPOINTS="$SLOWDOWN_FAILPOINTS;github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/FailBeforeIndexEngineImported=return"
...
export GO_FAILPOINTS="$SLOWDOWN_FAILPOINTS;github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/SetTaskID=return(1357924680);github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/FailIfIndexEngineImported=return(1)"
