...
GO_FAILPOINTS="github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/getTableStructuresByFileMeta_BeforeFetchRemoteTableModels=return(6000)" run_lightning &
pid=$!
