...
PKG="github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer"
...
export GO_FAILPOINTS="${GO_FAILPOINTS};github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/PrintStatus=return()"
...
export GO_FAILPOINTS="github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/PrintStatus=return()"
set +e
run_lightning -d "$DBPATH" --backend tidb --enable-checkpoint=1 2> /dev/null
set -e
