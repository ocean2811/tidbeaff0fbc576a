...
export GO_FAILPOINTS='github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/FailIfEngineCountExceeds=return(4)'
...
export GO_FAILPOINTS="github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/setExtStorage=return(\"$DBPATH2\")"
export GO_FAILPOINTS="$GO_FAILPOINTS;github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/setCheckpointName=return(\"test_checkpoint.pb\")"
