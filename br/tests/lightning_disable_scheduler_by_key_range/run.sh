...
export GO_FAILPOINTS="github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/EnableTestAPI=return"
export GO_FAILPOINTS="${GO_FAILPOINTS};github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/ReadyForImportEngine=sleep(10000)"
