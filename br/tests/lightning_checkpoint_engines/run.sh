...
# Data engine part
export GO_FAILPOINTS='github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/SlowDownImport=sleep(500);github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/FailIfStatusBecomes=return(120);github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/FailIfIndexEngineImported=return(140)'
