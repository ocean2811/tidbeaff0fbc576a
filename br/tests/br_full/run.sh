...
export GO_FAILPOINTS="github.com/ocean2811/tidbeaff0fbc576a/br/pkg/backup/reset-retryable-error=1*return(\"Unavailable\")->1*return(\"Internal\")"
...
export GO_FAILPOINTS="github.com/ocean2811/tidbeaff0fbc576a/br/pkg/backup/reset-not-retryable-error=1*return(true)"
...
export GO_FAILPOINTS="github.com/ocean2811/tidbeaff0fbc576a/br/pkg/backup/backup-storage-error=1*return(\"connection refused\")->1*return(\"InternalError\");github.com/ocean2811/tidbeaff0fbc576a/br/pkg/backup/backup-timeout-error=1*return(\"<Code>RequestTimeout</Code>\")->1*return(\"not read from or written to within the timeout period\")->1*return(\"<Code>InvalidPart</Code>\")->1*return(\"end of file before message length reached\")->1*return(\"timeout after\")"
...
for ct in limit lz4 zstd; do
  ...
  export GO_FAILPOINTS="github.com/ocean2811/tidbeaff0fbc576a/br/pkg/restore/restore-storage-error=1*return(\"connection refused\");github.com/ocean2811/tidbeaff0fbc576a/br/pkg/restore/restore-gRPC-error=1*return(true)"
  export GO_FAILPOINTS=$GO_FAILPOINTS";github.com/ocean2811/tidbeaff0fbc576a/br/pkg/restore/no-leader-error=3*return(true)"
