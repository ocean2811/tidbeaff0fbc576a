...
# restore full
echo "restore start..."
export GO_FAILPOINTS="github.com/ocean2811/tidbeaff0fbc576a/br/pkg/restore/restore-createtables-error=return(true)"
...
# restore full
echo "restore start..."
export GO_FAILPOINTS="github.com/ocean2811/tidbeaff0fbc576a/br/pkg/pdutil/PDEnabledPauseConfig=return(true)"
