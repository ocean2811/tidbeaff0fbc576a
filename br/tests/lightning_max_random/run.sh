...
export GO_FAILPOINTS="github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/changeEpochVersion=1*return(-1)"
...
export GO_FAILPOINTS="github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/changeEpochVersion=1*return(10)"
