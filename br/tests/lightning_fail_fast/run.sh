...
export GO_FAILPOINTS='github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/SlowDownWriteRows=sleep(100);github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/SetMinDeliverBytes=return(1)'
