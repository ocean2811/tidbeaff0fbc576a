...
export GO_FAILPOINTS="github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/SetTaskID=return(1234567890);github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/FailIfImportedChunk=return"
