...
```sh
make br_unit_test ARGS='github.com/ocean2811/tidbeaff0fbc576a/br/pkg/cdclog --test.v --check.v --check.f TestColumn'
#                      ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
go test github.com/ocean2811/tidbeaff0fbc576a/br/pkg/cdclog --test.v --check.v --check.f TestColumn
