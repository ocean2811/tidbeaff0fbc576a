...
export GO_FAILPOINTS="github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/SetCertExpiredSoon=return(\"$TEST_DIR/certs/ca.key\")"
export GO_FAILPOINTS="${GO_FAILPOINTS};github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/SlowDownWriteRows=sleep(15000)"
