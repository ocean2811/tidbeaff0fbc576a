...
export GO_FAILPOINTS='github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/FailAfterWriteRows=panic'
...
export GO_FAILPOINTS='github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/FailAfterWriteRows=1*return->panic'
