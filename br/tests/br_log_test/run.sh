...
export GO_FAILPOINTS="github.com/ocean2811/tidbeaff0fbc576a/br/pkg/backup/tikv-rw-error=return(\"Io(Os { code: 13, kind: PermissionDenied...})\")"
...
export GO_FAILPOINTS="github.com/ocean2811/tidbeaff0fbc576a/br/pkg/backup/tikv-rw-error=return(\"Io(Os { code: 2, kind:NotFound...})\")"
