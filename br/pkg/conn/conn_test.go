...
func TestGetAllTiKVStoresWithRetryCancel(t *testing.T) {
	_ = failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/conn/hint-GetAllTiKVStores-cancel", "1*return(true)->1*return(false)")
	defer func() {
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/conn/hint-GetAllTiKVStores-cancel")
	}()
...
func TestGetAllTiKVStoresWithUnknown(t *testing.T) {
	_ = failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/conn/hint-GetAllTiKVStores-error", "1*return(true)->1*return(false)")
	defer func() {
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/conn/hint-GetAllTiKVStores-error")
	}()
	ctx, cancel := context.WithCancel(context.Background())
	defer cancel()
