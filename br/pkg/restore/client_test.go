...
import (
	...
	"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/gluetidb"
	...
	"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/restore/tiflashrec"
	"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/stream"
	"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/utils"
	"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/utils/iter"
...
func TestNeedCheckTargetClusterFresh(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/restore/mock-incr-backup-data", "return(false)"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/restore/mock-incr-backup-data"))
	}()
...
func TestInitFullClusterRestore(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/restore/mock-incr-backup-data", "return(true)"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/restore/mock-incr-backup-data"))
	}()
	client.InitFullClusterRestore(false)
...
func TestGetTSWithRetry(t *testing.T) {
	...
	t.Run("PD leader failure:", func(t *testing.T) {
		require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/utils/set-attempt-to-one", "1*return(true)"))
		defer func() {
			require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/utils/set-attempt-to-one"))
		}()
		retryTimes := -1000
