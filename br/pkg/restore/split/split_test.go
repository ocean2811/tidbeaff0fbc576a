...
func TestScanRegionBackOfferWithFail(t *testing.T) {
	_ = failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/restore/split/hint-scan-region-backoff", "return(true)")
	defer func() {
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/restore/split/hint-scan-region-backoff")
	}()
