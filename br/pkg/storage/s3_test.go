...
func TestRetryError(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/storage/replace-error-to-connection-reset-by-peer", "return(true)"))
	defer func() {
		failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/storage/replace-error-to-connection-reset-by-peer")
	}()
...
func TestS3ReadFileRetryable(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/storage/read-s3-body-failed", "2*return(true)"))
	defer func() {
		failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/storage/read-s3-body-failed")
	}()
