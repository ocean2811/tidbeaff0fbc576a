...
import (
	...
	"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/checkpoint"
	pconfig "github.com/ocean2811/tidbeaff0fbc576a/br/pkg/config"
...
func runRestore(c context.Context, g glue.Glue, cmdName string, cfg *RestoreConfig) error {
	...
	//restore from tidb will fetch a general Size issue https://github.com/ocean2811/tidbeaff0fbc576a/issues/27247
	...
	// https://github.com/ocean2811/tidbeaff0fbc576a/blob/180c02127105bed73712050594da6ead4d70a85f/store/tikv/kv.go#L186-L190
