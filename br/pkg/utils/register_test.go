...
func TestTaskRegisterFailedGrant(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/utils/brie-task-register-failed-to-grant", "return(true)"))
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/utils/brie-task-register-always-grant", "return(true)"))
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/utils/brie-task-register-keepalive-stop", "return(true)"))
	defer func() {
		failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/utils/brie-task-register-failed-to-grant")
		failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/utils/brie-task-register-always-grant")
		failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/utils/brie-task-register-keepalive-stop")
	}()
	err := register.RegisterTask(ctx)
	require.NoError(t, err)
...
func TestTaskRegisterFailedReput(t *testing.T) {
	...
	register := NewTaskRegisterWithTTL(client, 3*time.Second, RegisterRestore, "test")
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/utils/brie-task-register-failed-to-reput", "return(true)"))
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/utils/brie-task-register-always-grant", "return(true)"))
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/utils/brie-task-register-keepalive-stop", "return(true)"))
	defer func() {
		failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/utils/brie-task-register-failed-to-reput")
		failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/utils/brie-task-register-always-grant")
		failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/utils/brie-task-register-keepalive-stop")
	}()
	err := register.RegisterTask(ctx)
