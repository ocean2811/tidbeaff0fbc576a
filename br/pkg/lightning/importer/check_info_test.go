...
func TestCheckTableEmpty(t *testing.T) {
	...
	err = failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/CheckTableEmptyFailed", `return`)
	require.NoError(t, err)
	defer func() {
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/CheckTableEmptyFailed")
	}()
