...
func DBFromConfig(ctx context.Context, dsn config.DBStore) (*sql.DB, error) {
	...
	vars := map[string]string{
		...
		// after https://github.com/ocean2811/tidbeaff0fbc576a/pull/17102 merge,
...
// See: https://github.com/ocean2811/tidbeaff0fbc576a/blob/64698ef9a3358bfd0fdc323996bb7928a56cadca/ddl/ddl_api.go#L2528-L2533
