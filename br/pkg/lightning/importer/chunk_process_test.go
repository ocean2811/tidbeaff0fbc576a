...
func (s *chunkRestoreSuite) TestEncodeLoopDeliverLimit() {
	...
	require.NoError(s.T(), failpoint.Enable(
		"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/mock-kv-size", "return(110000000)"))
	defer failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/mock-kv-size")
	_, _, err = s.cr.encodeLoop(ctx, kvsCh, s.tr, s.tr.logger, kvEncoder, deliverCompleteCh, rc)
	require.NoError(s.T(), err)
