...
import (
	...
	"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/tidb"
	"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/checkpoints"
	...
	"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/errormanager"
	restoremock "github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/mock"
	ropts "github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/opts"
	"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/log"
	"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/metric"
	"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/mydump"
	"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/precheck"
	"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/verification"
	"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/web"
	"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/worker"
	...
	tmock "github.com/ocean2811/tidbeaff0fbc576a/pkg/util/mock"
...
func (s *tableRestoreSuite) TestPopulateChunks() {
	_ = failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/PopulateChunkTimestamp", "return(1234567897)")
	defer func() {
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/PopulateChunkTimestamp")
	}()
...
func (s *tableRestoreSuite) TestSaveStatusCheckpoint() {
	_ = failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/SlowDownCheckpointUpdate", "sleep(100)")
	defer func() {
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/importer/SlowDownCheckpointUpdate")
	}()
