...
import (
	...
	lkv "github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/kv"
...
func TestEncodeRowFormatV2(t *testing.T) {
	// Test encoding in row format v2, as described in <https://github.com/ocean2811/tidbeaff0fbc576a/blob/master/docs/design/2018-07-19-row-format.md>.
...
// BenchmarkSQL2KV Run `go test -benchmem -run=^$ -bench ^BenchmarkSQL2KV$ github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/kv` to get benchmark result.
