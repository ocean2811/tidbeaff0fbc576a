...
import (
	...
	"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend"
	...
	"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/log"
	"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/membuf"
	...
	tidbkv "github.com/ocean2811/tidbeaff0fbc576a/pkg/kv"
...
func TestLocalWriteAndIngestPairsFailFast(t *testing.T) {
	bak := Backend{}
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/WriteToTiKVNotEnoughDiskSpace", "return(true)"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/WriteToTiKVNotEnoughDiskSpace"))
	}()
...
func TestDoImport(t *testing.T) {
	...
	_ = failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/skipSplitAndScatter", "return()")
	_ = failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/fakeRegionJobs", "return()")
	t.Cleanup(func() {
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/skipSplitAndScatter")
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/fakeRegionJobs")
	})
...
func TestCtxCancelIsIgnored(t *testing.T) {
	...
	_ = failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/skipSplitAndScatter", "return()")
	_ = failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/fakeRegionJobs", "return()")
	_ = failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/beforeGenerateJob", "sleep(1000)")
	_ = failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/WriteToTiKVNotEnoughDiskSpace", "return()")
	t.Cleanup(func() {
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/skipSplitAndScatter")
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/fakeRegionJobs")
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/beforeGenerateJob")
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/WriteToTiKVNotEnoughDiskSpace")
	})
...
func TestWorkerFailedWhenGeneratingJobs(t *testing.T) {
	...
	_ = failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/skipSplitAndScatter", "return()")
	_ = failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/sendDummyJob", "return()")
	_ = failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/mockGetFirstAndLastKey", "return()")
	_ = failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/WriteToTiKVNotEnoughDiskSpace", "return()")
	t.Cleanup(func() {
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/skipSplitAndScatter")
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/sendDummyJob")
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/mockGetFirstAndLastKey")
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/WriteToTiKVNotEnoughDiskSpace")
	})
...
func TestExternalEngine(t *testing.T) {
	_ = failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/skipSplitAndScatter", "return()")
	_ = failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/skipStartWorker", "return()")
	_ = failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/injectVariables", "return()")
	t.Cleanup(func() {
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/skipSplitAndScatter")
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/skipStartWorker")
		_ = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/injectVariables")
	})
	ctx := context.Background()
	dir := t.TempDir()
