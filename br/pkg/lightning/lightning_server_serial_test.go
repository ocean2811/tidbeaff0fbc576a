...
func createSuite(t *testing.T) *lightningServerSuite {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/SkipRunTask", "return"))
	t.Cleanup(func() {
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/SkipRunTask"))
		s.lightning.Stop()
	})
