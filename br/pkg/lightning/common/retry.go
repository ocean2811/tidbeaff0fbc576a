...
import (
	...
	tmysql "github.com/ocean2811/tidbeaff0fbc576a/pkg/errno"
	drivererr "github.com/ocean2811/tidbeaff0fbc576a/pkg/store/driver/error"
...
var retryableErrorMsgList = []string{
	...
	// see https://github.com/ocean2811/tidbeaff0fbc576a/blob/2c3d4f1ae418881a95686e8b93d4237f2e76eec6/store/copr/coprocessor.go#L941
	"coprocessor task terminated due to exceeding the deadline",
	// fix https://github.com/ocean2811/tidbeaff0fbc576a/issues/51383
	"rate: wait",
}
...
// https://github.com/ocean2811/tidbeaff0fbc576a/issues/48352
// https://github.com/ocean2811/tidbeaff0fbc576a/issues/46321 and I don't know why 😭
