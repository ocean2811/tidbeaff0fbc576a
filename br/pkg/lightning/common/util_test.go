...
func TestConnect(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable(
		"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/common/MustMySQLPassword",
		fmt.Sprintf("return(\"%s\")", plainPsw)))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/common/MustMySQLPassword"))
	}()
