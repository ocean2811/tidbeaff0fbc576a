...
import (
	...
	connutil "github.com/ocean2811/tidbeaff0fbc576a/br/pkg/conn/util"
...
func BuildBackupRangeAndInitSchema(
	...
	if isFullBackup {
		// according to https://github.com/ocean2811/tidbeaff0fbc576a/issues/32290
		...
		err = m.IterTables(dbInfo.ID, func(tableInfo *model.TableInfo) error {
			...
			default:
				if tableInfo.SepAutoInc() {
					...
					// See also https://github.com/ocean2811/tidbeaff0fbc576a/issues/46093
