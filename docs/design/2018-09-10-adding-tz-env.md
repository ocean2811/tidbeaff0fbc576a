...
After we solved the daylight saving time issue, we found the performance degradation of TiKV side. Thanks for the investigation done by engineers from TiKV. The root cause of such performance degradation is that TiKV infers `System` timezone name via a third party lib, which calls a syscall and costs a lot. In our internal benchmark system, after [this PR](https://github.com/ocean2811/tidbeaff0fbc576a/pull/6823), our codebase is 1000 times slower than before. We have to address this. 
...
PR of this proposal: https://github.com/ocean2811/tidbeaff0fbc576a/pull/7638/files
