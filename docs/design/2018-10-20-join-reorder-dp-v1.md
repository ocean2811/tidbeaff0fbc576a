...
[PR#8025](https://github.com/ocean2811/tidbeaff0fbc576a/pull/8025) contains step 3 and 4. Step 2 is done when extract the join group. Step 1 and 5 will be involved in the future pull request.
