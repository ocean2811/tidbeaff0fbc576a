...
import (
	...
	"github.com/ocean2811/tidbeaff0fbc576a/br/pkg/task/operator"
...
func TestFailure(t *testing.T) {
	req := require.New(t)
	req.NoError(failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/backup/prepare_snap/PrepareConnectionsErr", "return()"))
	// Make goleak happy.
	req.NoError(failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/task/operator/SkipReadyHint", "return()"))
	defer func() {
		req.NoError(failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/backup/prepare_snap/PrepareConnectionsErr"))
		req.NoError(failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/task/operator/SkipReadyHint"))
	}()
