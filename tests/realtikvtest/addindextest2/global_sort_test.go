...
func TestGlobalSortBasic(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/forceMergeSort", "return()"))
	...
	checkFileCleaned(t, jobID, cloudStorageURI)
	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/framework/dispatcher/WaitCleanUpFinished"))
	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/forceMergeSort"))
}
