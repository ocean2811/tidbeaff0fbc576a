...
func TestAddIndexDistBasic(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/framework/scheduler/MockRunSubtaskContextCanceled", "1*return(true)"))
	tk.MustExec("alter table t1 add index idx1(a);")
	tk.MustExec("admin check index t1 idx1;")
	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/framework/scheduler/MockRunSubtaskContextCanceled"))

	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/injectPanicForTableScan", "return()"))
	tk.MustExecToErr("alter table t1 add index idx2(a);")
	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/injectPanicForTableScan"))

	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/injectPanicForIndexIngest", "return()"))
	tk.MustExecToErr("alter table t1 add index idx2(a);")
	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/injectPanicForIndexIngest"))
...
func TestAddIndexDistCancel(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/mockDMLExecutionAddIndexSubTaskFinish", "1*return(true)"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/mockDMLExecutionAddIndexSubTaskFinish"))
	}()
...
func TestAddIndexDistPauseAndResume(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/mockDMLExecutionAddIndexSubTaskFinish", "3*return(true)"))
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/framework/dispatcher/mockDMLExecutionOnPausedState", "return(true)"))
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/syncDDLTaskPause", "return()"))
	tk.MustExec(`set global tidb_enable_dist_task=1;`)
	tk.MustExec("alter table t add index idx1(a);")
	tk.MustExec("admin check table t;")
	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/mockDMLExecutionAddIndexSubTaskFinish"))
	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/framework/dispatcher/mockDMLExecutionOnPausedState"))
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/pauseAfterDistTaskFinished", "1*return(true)"))
	tk.MustExec("alter table t add index idx3(a);")
	tk.MustExec("admin check table t;")
	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/pauseAfterDistTaskFinished"))
	require.NoError(t, failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/ddl/syncDDLTaskPause"))
...
func TestAddIndexTSErrorWhenResetImportEngine(t *testing.T) {
	...
	err := failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/mockAllocateTSErr", `1*return`)
	require.NoError(t, err)
	tk.MustExec("create table t (a int);")
	tk.MustExec("insert into t values (1), (2), (3);")
	dom.DDL().SetHook(cb)
	tk.MustExec("alter table t add index idx(a);")
	err = failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/br/pkg/lightning/backend/local/mockAllocateTSErr")
	require.NoError(t, err)
