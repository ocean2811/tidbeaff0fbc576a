...
import (
	...
	"github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/importer"
...
func (s *mockGCSSuite) TestShowJob() {
	...
	s.enableFailpoint("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/importer/setLastImportJobID", `return(true)`)
	s.enableFailpoint("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/framework/storage/testSetLastTaskID", "return(true)")
	s.enableFailpoint("github.com/ocean2811/tidbeaff0fbc576a/pkg/parser/ast/forceRedactURL", "return(true)")
	...
	s.enableFailpoint("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/framework/scheduler/syncAfterSubtaskFinish", `return(true)`)
	s.server.CreateObject(fakestorage.Object{
	...
	go func() {
		...
		s.NoError(failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/framework/scheduler/syncAfterSubtaskFinish"))
		scheduler.TestSyncChan <- struct{}{}
	}()
...
func (s *mockGCSSuite) TestShowDetachedJob() {
	...
	s.enableFailpoint("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/importinto/errorWhenSortChunk", "return(true)")
...
func (s *mockGCSSuite) TestCancelJob() {
	...
	s.enableFailpoint("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/importinto/waitBeforeSortChunk", "return(true)")
	s.enableFailpoint("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/importinto/syncAfterJobStarted", "return(true)")
	...
	s.NoError(s.tk.Session().Auth(&auth.UserIdentity{Username: "test_cancel_job2", Hostname: "localhost"}, nil, nil, nil))
	s.NoError(failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/importinto/waitBeforeSortChunk"))
	s.NoError(failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/importinto/syncAfterJobStarted"))
	s.enableFailpoint("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/importinto/syncBeforePostProcess", "return(true)")
	s.enableFailpoint("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/importinto/waitCtxDone", "return(true)")
	...
	s.NoError(failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/importinto/syncBeforePostProcess"))
	s.NoError(failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/importinto/waitCtxDone"))
	s.enableFailpoint("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/importinto/syncBeforeJobStarted", "return(true)")
	s.NoError(s.tk.Session().Auth(&auth.UserIdentity{Username: "root", Hostname: "localhost"}, nil, nil, nil))
...
func (s *mockGCSSuite) TestJobFailWhenDispatchSubtask() {
	...
	s.enableFailpoint("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/importinto/failWhenDispatchPostProcessSubtask", "return(true)")
	s.enableFailpoint("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/importer/setLastImportJobID", `return(true)`)
	s.NoError(s.tk.Session().Auth(&auth.UserIdentity{Username: "root", Hostname: "localhost"}, nil, nil, nil))
...
func (s *mockGCSSuite) TestKillBeforeFinish() {
	...
	s.enableFailpoint("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/importinto/syncBeforeSortChunk", "return(true)")
	s.enableFailpoint("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/cancellableCtx", "return(true)")
	s.enableFailpoint("github.com/ocean2811/tidbeaff0fbc576a/pkg/executor/importer/setLastImportJobID", `return(true)`)
	wg := sync.WaitGroup{}
	wg.Add(1)
	go func() {
