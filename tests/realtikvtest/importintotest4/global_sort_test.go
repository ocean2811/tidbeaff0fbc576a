...
func (s *mockGCSSuite) TestGlobalSortBasic() {
	...
	// merge-sort data kv
	s.enableFailpoint("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/importinto/forceMergeSort", `return("data")`)
	...
	s.enableFailpoint("github.com/ocean2811/tidbeaff0fbc576a/pkg/disttask/importinto/failWhenDispatchWriteIngestSubtask", "return(true)")
	s.tk.MustExec("truncate table t")
