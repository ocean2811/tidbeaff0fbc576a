...
export GO_FAILPOINTS="github.com/ocean2811/tidbeaff0fbc576a/dumpling/export/ChaosBrokenWriterConn=1*return;github.com/ocean2811/tidbeaff0fbc576a/dumpling/export/ChaosBrokenMetaConn=1*return"
