...
func TestSetSessionParams(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/dumpling/export/SkipResetDB", "return(true)"))
	defer failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/dumpling/export/SkipResetDB=return(true)")
