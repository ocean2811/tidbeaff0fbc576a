...
func TestWriteTableMeta(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/dumpling/export/FailToCloseMetaFile", "return(true)"))
	defer failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/dumpling/export/FailToCloseMetaFile=return(true)")
...
func TestWriteTableData(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/ocean2811/tidbeaff0fbc576a/dumpling/export/FailToCloseDataFile", "return(true)"))
	defer failpoint.Disable("github.com/ocean2811/tidbeaff0fbc576a/dumpling/export/FailToCloseDataFile=return(true)")
