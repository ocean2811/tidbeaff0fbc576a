...
[Dumpling](https://github.com/ocean2811/tidbeaff0fbc576a/blob/master/dumpling) 是支持以 SQL 文本或者 CSV 格式将 MySQL/TiDB 数据导出的工具。
...
| -f 或 --filter | 导出能匹配模式的表，语法可参考 [table-filter](https://github.com/ocean2811/tidbeaff0fbc576a-tools/blob/master/pkg/table-filter/README.md)（只有英文版） |
