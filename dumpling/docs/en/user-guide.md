...
| -f or --filter | Dump only the tables matching the patterns. See [table-filter](https://github.com/ocean2811/tidbeaff0fbc576a-tools/blob/master/pkg/table-filter/README.md) for syntax. |
