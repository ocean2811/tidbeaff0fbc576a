...
func main() {
	...
	const prefix = "github.com/ocean2811/tidbeaff0fbc576a/"
	if !strings.HasPrefix(pkg, prefix) {
		os.Exit(-3)
	}

	// github.com/ocean2811/tidbeaff0fbc576a/pkg/util/topsql.test => util/topsql
...
func getPackageInfo(dir string) string {
	...
	r := bufio.NewReader(f)
	// packagefile github.com/ocean2811/tidbeaff0fbc576a/pkg/session.test=/home/genius/.cache/go-build/fb/fb1587cce5727fa9461131eab8260a52878da04f5c8da49dd3c7b2d941430c63-d
